 ...
 * 1. 类的用途
 * 2. @author：liqingyi
 * 3. @date：2017/2/10 20:53
 */

public class CanvasVonvertTouchRawTest extends CustomView {
    float down_x = -1;
    float down_y = -1;

    public CanvasVonvertTouchRawTest(Context context) {
        this(context, null);
    }

    public CanvasVonvertTouchRawTest(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
